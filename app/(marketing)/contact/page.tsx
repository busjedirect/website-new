                ...
                <div key={item.label}>
                  {item.href ? (
                    <a
                      ...
                      className="group flex items-start gap-4 rounded-2xl border border-zinc-100 bg-[#F5F6F7] p-6 transition hover:border-[#FF7A00]/30 hover:bg-white hover:shadow-md"
                    >
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#FFF3E8]">
                        {item.icon}
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-[12px] font-semibold uppercase tracking-wide text-zinc-400">{item.label}</p>
                        <p className="mt-1 text-[15px] font-bold text-[#111111] group-hover:text-[#FF7A00]">{item.value}</p>
