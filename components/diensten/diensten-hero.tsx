...
function ShieldIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#E31B1B" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-16">
          ...
          <div className="flex-1">
            ...
            <h1 className="text-[32px] font-extrabold leading-[1.1] tracking-tight text-[#111111] sm:text-[42px]">
              ...
              <span className="text-[#E31B1B]">Snel, veilig en betrouwbaar.</span>
            </h1>
